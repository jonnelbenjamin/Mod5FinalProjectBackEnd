...
User.create(first_name:"Jonnel", last_name:"Benjamin", email:"jonnel.benjamin@gmail.com", profession:"programmer", credit_card_number:"1234567891011121")
...
Disaster.create(type:"Earthquake", active:false, latitude:, longitude:, location_id: 1)
Disaster.create(type:"Tornado", active:false, latitude:, longitude:, location_id: 2)
Disaster.create(type:"Tsunami", active:true, latitude:, longitude:, location_id: 3)
Disaster.create(type:"Flooding", active:false, latitude:, longitude:, location_id: 4)
Disaster.create(type:"Famine", active:true, latitude:, longitude:, location_id: 5)
Disaster.create(type:"Famine", active:false, latitude:, longitude:, location_id: 6)
Disaster.create(type:"Flooding", active:false, latitude:, longitude:, location_id: 7)
Disaster.create(type:"Monsoon", active:false, latitude:, longitude:, location_id: 8)
Disaster.create(type:"Flooding", active:false, latitude:, longitude:, location_id: 9)
Disaster.create(type:"Hurricane", active:false, latitude:, longitude:, location_id: 10)
